...
public class WatchListConstants {
    ...
    public static final String SELECT_WATCHLIST_FOR_USERID = "SELECT" +
            ...
            " watchlist.lastWatched as 'watchlist.lastWatched', movies.title as 'movies.title', movies.description as 'movies.description', movies.director as director_id, movies.year as 'movies.year', movies.rtPath as 'movies.rtPath'," +
            ...
            " persons.name as 'directors.name', persons.imageURL as 'directors.imageURL', persons.rtPath as 'directors.rtPath', persons.bio as 'directors.bio'" +
            " FROM watchlist" +
