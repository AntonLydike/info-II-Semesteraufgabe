...
public class UserConstants {
    ...
    public final static String ADD_WATCHLIST = "INSERT INTO watchlist (`user_id`,`movie_id`, `personalRating`,`lastWatched`) VALUES (?, ?, ?, ?)";
    public final static String REMOVE_WATCHLIST_ITEM_BY_USER_MOVIE = "DELETE FROM watchlist WHERE user_id = ? AND movie_id = ? ";
    public final static String WATCHLIST_ITEM_SET_WATCHED = "UPDATE watchlist SET `lastWatched` = CURRENT_TIMESTAMP WHERE user_id = ? AND movie_id = ?";
